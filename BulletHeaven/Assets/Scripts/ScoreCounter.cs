...
public class ScoreCounter : MonoBehaviour
{
    ...
    void healthChecker(){
        /*if(health == 0){
            ...
            //GameObject.Find("HealthCross (1)").SetActive(true);
            GameObject.Find("HealthCross (2)").SetActive(false);
            GameObject.Find("HealthCross (3)").SetActive(false);
        } else if (health == 2){
            //GameObject.Find("HealthCross (1)").SetActive(true);
            //GameObject.Find("HealthCross (2)").SetActive(true);
            GameObject.Find("HealthCross (3)").SetActive(false);
        } else if (health == 3){
            //GameObject.Find("HealthCross (1)").SetActive(true);
            //GameObject.Find("HealthCross (2)").SetActive(true);
            //GameObject.Find("HealthCross (3)").SetActive(true);
        }*/
    ...
    void haloChecker(){
        /* if(halos == 0){
            ...
            GameObject.Find("HaloImage (1)").SetActive(true);
            GameObject.Find("HaloImage (2)").SetActive(false);
            GameObject.Find("HaloImage (3)").SetActive(false);
        } else if (halos == 2){
            GameObject.Find("HaloImage (1)").SetActive(true);
            GameObject.Find("HaloImage (2)").SetActive(true);
            GameObject.Find("HaloImage (3)").SetActive(false);
        } else if (halos == 3){
            GameObject.Find("HaloImage (1)").SetActive(true);
            GameObject.Find("HaloImage (2)").SetActive(true);
            GameObject.Find("HaloImage (3)").SetActive(true);
        }*/

        if(halos == 3 && previousHalos != halos){
        }else if(halos == 2 && previousHalos != halos){
            GameObject.Find("HaloImage (3)").SetActive(false);
            previousHalos = halos;
